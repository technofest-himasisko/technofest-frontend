        ...
        <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-2">
          <Card className="flex flex-col items-center text-center">
            ...
            <div className="mt-2 flex gap-x-4 md:mt-4">
              ...
              <Link
                href="#"
                className="flex w-full items-center justify-center space-x-1 text-center text-sm font-semibold hover:text-brand-line md:w-auto md:text-base"
              >
                <svg
                  ...
                  fill="currentColor"
                  viewBox="0 0 16 16"
                  className="size-[1.3em] fill-brand-line"
                >
